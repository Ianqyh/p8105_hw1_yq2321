...
```
    ...
    ##       <dbl> <lgl>       <chr>    <fct>     
    ##  1  -1.65   FALSE       My       Asian     
    ##  2  -1.14   FALSE       name     White     
    ##  3  -0.423  FALSE       is       Black     
    ##  4   1.73   TRUE        Yihan    Asian     
    ##  5  -0.335  FALSE       Qiu      White     
    ##  6  -0.795  FALSE       and      Black     
    ##  7  -1.66   FALSE       I'm      Asian     
    ##  8   0.505  TRUE        a        White     
    ##  9  -0.302  FALSE       graduate Black     
    ## 10   0.0879 TRUE        student  Asian
